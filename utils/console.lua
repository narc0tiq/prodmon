--- Debug console.
-- Originally from Factorio-stdlib
-- (Copyright (c) 2016 Afforess, licensed under the ISC license --
--  see STDLIB-LICENSE in this package)
--
...
gui.register_on_click('^'..names.enter..'$', enter)

local function close(event)
    event.element.parent.destroy()
end
gui.register_on_click('^'..names.close..'$', close)

local function clear(event)
    event.element.parent[names.scroll][names.textbox].text = ""
end
gui.register_on_click('^'..names.clear..'$', clear)
